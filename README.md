...
* Clone this repository, `cd` into it, then run `pip install .`. This will install two packages: `geneo` and `cgeneo` (used by the former internally). You will need a compiler that supports C++17.
