...
def test_descendants():
    assert gen.descendant(ped, [10086]) == [
        10009, 10018, 10033, 33724, 105379, 113470, 408065, 408069, 408075,
        408375, 408937, 409808, 623919, 712249, 712256, 860834, 860838,
        868738, 868740, 868743]
...
def test_sparse_kinships():
    ...
    assert abs(gen.phiMean(phi) - 0.0011437357709631094) < 1e-8
